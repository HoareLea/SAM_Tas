...
namespace SAM.Analytical.Tas.TPD
{
    ...
    {
        public static SystemHeatingCoilResult ToSAM_SystemHeatingCoilResult(this HeatingCoil heatingCoil, int start, int end, params HeatingCoilDataType[] heatingCoilDataTypes)
        {
            if (heatingCoil == null)
            {
                return null;
