namespace SAM.Analytical.Tas
{
    public static partial class Query
    {
        public static System.Drawing.Color? Color(this Aperture aperture, AperturePart aperturePart)
        {
            ...
            if (aperturePart == AperturePart.Pane && aperture.TryGetValue(Analytical.ApertureParameter.Color, out System.Drawing.Color color_Temp) && color_Temp != global::System.Drawing.Color.Empty)
            {
                color = color_Temp;
            }
