        ...
        public static bool TPD(this string path_TPD, string path_TSD, AnalyticalModel analyticalModel = null)
        {
            ...
            using (SAMTPDDocument sAMTPDDocument = new SAMTPDDocument(path_TPD))
            {
                ...
                if (tPDDoc != null)
                {
                    ...
                    plantRoom.SimulateEx(1, 8760, 0, energyCentre.ExternalPollutant.Value, 10.0, (int)global::TPD.tpdSimulationData.tpdSimulationDataLoad + (int)global::TPD.tpdSimulationData.tpdSimulationDataPipe + (int)global::TPD.tpdSimulationData.tpdSimulationDataDuct + (int)global::TPD.tpdSimulationData.tpdSimulationDataSimEvents, 1, 0);
                    ...
                    if(analyticalModel != null)
                    {
                        ...
                        for (int j = 1; j <= count; j++)
                        {
                            TPD.WrResultItem wrResultItem = (TPD.WrResultItem)wrResultSet.GetResultItem(global::TPD.tpdResultVectorType.tpdCo2, j);
                            if (wrResultItem != null)
                            {
                                Array array = (Array)wrResultItem.GetValues();
                                if (array != null && array.Length != 0)
