...
{
    public class SAMAnalyticalResultPeriod : GH_SAMEnumComponent<ResultPeriod>
    {
        /// <summary>
        ...
        /// Panel Type
        /// </summary>
        public SAMAnalyticalResultPeriod()
          : base("SAMAnalytical.ResultPeriod", "SAMAnalytical.ResultPeriod",
              "Select ResultPeriod",
              "SAM", "Analytical")
        {
        }
