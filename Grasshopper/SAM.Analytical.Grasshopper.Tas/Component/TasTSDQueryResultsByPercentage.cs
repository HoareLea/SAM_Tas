    ...
    public class TasTSDQueryResultsByPercentage : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                global::Grasshopper.Kernel.Parameters.Param_String @string = new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "numberComparisonType_", NickName = "spaceDataType_", Access = GH_ParamAccess.item, Optional = true};
                number.SetPersistentData(NumberComparisonType.GreaterOrEquals.Text());
