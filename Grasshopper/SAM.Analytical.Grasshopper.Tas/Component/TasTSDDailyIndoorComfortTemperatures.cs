...
{
    public class TasTSDDailyIndoorComfortTemperatures : GH_SAMVariableOutputParameterComponent
    {
        /// <summary>
        /// Gets the unique ID for this component. Do not change this ID after release.
        /// </summary>
        public override Guid ComponentGuid => new Guid("5ef8ebef-d67d-4ab5-8bf4-1318a4c52baf");
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_FilePath() { Name = "_path_TSD", NickName = "_path_TSD", Description = "Path to TSD Tas File", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
